...
\mynote<2>{Este proyecto no se me ha ocurrido, en el año 2018 estuve trabajando con cargo a un convenio con la comunidad de Madrid.
	Contactaron conmigo a traves de una persona de la UPM (Marina). Estuve trabajando de junio a diciembre.
	En el convenio trabajaron 2 personas, 2 profesores y 3 personas de la Comunidad de Madrid.
	En ese convenio el objetivo era estudiar todos los datos de la comunidad de madrid para hacer una explotacion razonable. AL hilo de este proyecto, surge la necesidad de avanzar mas
	darle una vuelta de tuerca, surge la posibilidad de utilizar tecnicas predictivas para la gestion educativa. Estaba en el nucleo donde se toman las decisioines.
	Se trabajaba con el director del area tecnica. He interactuado con profesores que han sido directores y ahora son ATD (Asesor Tecnico Docente).}
...
\begin{block}{¿Que es la gestión educativa?} 
	Es un proceso continuo de toma de decisiones; desde las fases de planeación hasta las de evaluación, pasando por procesos
...
\makebox[\textwidth]{\includegraphics[width=12.5cm,height=6cm]{figures/PropuestaIntervencion}}
\end{frame}
...
\begin{block}{Análisis predictivo}
	Se muestran los resultados obtenidos en el analisis de predicción.
\end{block}
\frametitle{\secname : \subsecname}
\begin{itemize}
	...
	\item Algoritmo con mejores predicciones: Árbol de Decisión, seguido de la Regresión Lineal.
	\item En la prediccion: de 4436 datos existentes para grupos, únicamente 52 se modifican. De estos 52 grupos, 30 de ellos disminuyen en el número de unidades y 22 aumentan. Se observa para este curso 2017/2018, que \textbf{se reduce la población en el aula}.
\end{itemize}
