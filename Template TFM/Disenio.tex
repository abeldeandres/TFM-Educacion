...
Una vez que se tiene claro la arquitectura principal del sistema, se va establece el camino a seguir a la hora de realizar la investigación. Para ello, se utiliza la metodologia CRISP-DM. \citeA{IBMCRISP2012}
