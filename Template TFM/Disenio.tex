...
Es un algoritmo de regresión que se utiliza para predecir el resultado de una variable categorica en funcion de las variables independientes o predictoras. Para predecir el resultado, se establecen pesos en funcion de la puntuacion dada a cada variable independiente.
